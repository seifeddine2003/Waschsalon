...
import com.start.waschmachine.Reservation.Reservation;
import com.start.waschmachine.Reservation.ReservationRepository;
...
public class SlotController {
    ...
    public List<Map<String, Object>> getAvailableSlots(@RequestParam Integer machineId) {
        ...
        // Get all reservations for this machine today
